local M = {}
local config = require("dawn-sexy.config")

local function set_highlights()
	local utilities = require("dawn-sexy.utilities")
	local palette = require("dawn-sexy.palette")
	...
	local default_highlights = {
		...
		Conceal                                  = { bg = "NONE" },
		CurSearch                                = { fg = palette.base, bg = palette.rose },
		Cursor                                   = { fg = palette.text, bg = palette.highlight_high },
		TermCursor                               = { fg = palette.gold, bg = palette.gold },
		...
		SpellBad                                 = { fg = groups.warn, sp = palette.subtle, undercurl = true },
		SpellCap                                 = { fg = groups.warn, sp = palette.subtle, undercurl = true },
		SpellLocal                               = { fg = groups.warn, sp = palette.subtle, undercurl = true },
		SpellRare                                = { fg = groups.warn, sp = palette.subtle, undercurl = true },
		...
		IlluminatedWordWrite                     = { link = "CurSearch" },
		...
		TelescopeTitle                           = { fg = palette.pine, bold = styles.bold },
	...
	--- Terminal
	-- TODO: Need to update colors here (and names of palette colors)
